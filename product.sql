...
CREATE TABLE time_deals (
    id INT PRIMARY KEY AUTO_INCREMENT, -- 타임딜 번호
    product_id INT NOT NULL, -- 타임딜 상품번호 (FK)
    deal_price INT NOT NULL,  -- 세일 가격
    start_time DATETIME NOT NULL, -- 타임딜 시작시간
    end_time DATETIME NOT NULL, -- 타임딜 종료시간
    is_active BOOLEAN DEFAULT TRUE, -- 타임딜 진행중이면 1, 종료: 0
