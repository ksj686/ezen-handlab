  ...
  return (
    <div className="mx-auto flex w-full flex-col items-center px-4 py-8">
      ...
      <div className="flex w-full flex-col gap-4 md:flex-row">
        ...
        <div className="w-full rounded-lg border p-6 md:w-5/9">
          <div className="mb-8">
            ...
            <ul className="list-disc space-y-2 pl-5">
              ...
              <li>상단 필터의 마이크 권한을 '허용'으로 선택해 주세요.</li>
          ...
          <div className="mb-8">
            ...
            <ul className="list-disc space-y-2 pl-5">
              <li>
                마이크 사용 중 화음앱(소리 증폭 현상)이 발생하면 소리가 겹쳐서
                음성 검출이 어려워질 수 있습니다.
              </li>
              <li>이어폰 사용 시에는 마이크가 있는 기기를 사용해 주세요.</li>
              <li>음성 진단에 영향을 미치는 마스크를 착용하지 말아 주세요.</li>
            </ul>
          </div>
          <div>
            <div className="text-zik-text/75 mb-3 text-[24px] font-bold">
            ...
            <ul className="list-disc space-y-2 pl-5">
              ...
              <li>
                연결 중 페이지를 벗어날 시, 처음부터 다시 시작해야 합니다.
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="w-full rounded-lg border bg-white p-6 md:w-4/9">
