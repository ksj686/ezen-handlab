    ...
    <div className="mx-auto my-12 max-w-lg px-4">
      <div className="mb-2 flex items-center justify-between">
        <div className="text-center">
          ...
          <div className="text-3xl font-bold text-indigo-500">{leftValue}%</div>
        </div>
        <div className="text-center">
      ...
      >
        ...
        >
          <div className="-ml-4 flex h-8 w-8 cursor-pointer items-center justify-center rounded-full border-2 border-white bg-indigo-500 shadow-md">
      ...
      <div className="mt-8 text-center text-gray-600">
        인성과 직무의 비율을 조절하려면 원형 핸들을 드래그하세요 (10% 단위)
      </div>
    </div>
  );
};
