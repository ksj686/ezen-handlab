// document 에 "data-filter-id" 속성을 가진 요소를 filters에 저장
// 각각의 버튼 filterBtns에 저장
// forEach를 이용하여 각각의 filters 데이터를 순회하여 해당 filter 내에서
...
//   const filterBtns = [...filter.querySelectorAll("[data-filter]")].filter(
//     (el) => el.nodeName === "BUTTON"
//   );
//   const filterList = [...filter.querySelectorAll("[data-filter]")].filter(
//     (el) => el.nodeName === "LI"
//   );
...
// 버튼을 클릭하면 클릭한 버튼은 active 를 적용하고 나머지 버튼은 클래스 취소
